...
namespace DapperExtensions.Test.IntegrationTests.Postgre
{
    [TestFixture]
    public class CrudFixture
    {
        [TestFixture]
        public class InsertMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class DeleteMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class UpdateMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetListMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetPageMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class CountMethod : PostgreBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMultipleMethod : PostgreBaseFixture
        {
            [Test]
