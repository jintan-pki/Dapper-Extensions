...
{
    public class PostgreBaseFixture
    {
        ...
        {
            var connection = new NpgsqlConnection("Host=localhost;Port=9257;Database=dapperTest;User ID=postgres;Password=Yours;Pooling=true;");
